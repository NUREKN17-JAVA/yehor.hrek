...
public class SearchGui extends JFrame {
	...
	private JTable getTable() {
		if (table == null) {
			table = new JTable(new ua.nure.kn.hrek.usermanagement.gui.UserTableModel(new LinkedList()));
		}
		return table;
	}
	...
	class SearchPanel extends JPanel implements ActionListener {
		...
		private JButton getCancelButton() {
			if (cancelButton == null) {
				...
				cancelButton.setText(ua.nure.kn.hrek.usermanagement.util.Messages.getString("AddPanel.cancel")); //$NON-NLS-1$
	...
	public void addUsers(Collection users) {
		...
		ua.nure.kn.hrek.usermanagement.gui.UserTableModel model = (ua.nure.kn.hrek.usermanagement.gui.UserTableModel) getTable()
				.getModel();
